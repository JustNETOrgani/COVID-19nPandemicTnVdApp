    ...
    pushTransactionToBlockchain (personHID, hIPFShash, sig) {
      ...
      try {
        ...
        const txParams = {
          ...
          to: contractAddress,
          data: blockCovid.methods.updatePersonBlockchainAddr(this.newPersonAddress, personHID, hIPFShash, sig).encodeABI()
        }
        this.sendTnx(txParams).then(tnxReceipt => {
          ...
          this.addrUpdateBtnLoadState = false
          this.$alert('Address successfully updated on BlockCovid-19.', 'Address update success', {
